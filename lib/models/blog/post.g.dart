...
extension PostQueryWhereSort on QueryBuilder<Post, Post, QWhere> {
  ...
  QueryBuilder<Post, Post, QAfterWhere> anyTitle() {
    return QueryBuilder.apply(this, (query) {
...
extension PostQueryWhere on QueryBuilder<Post, Post, QWhereClause> {
  ...
  QueryBuilder<Post, Post, QAfterWhereClause> titleIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Post, Post, QAfterWhereClause> titleIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Post, Post, QAfterWhereClause> titleEqualTo(String? title) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'title',
        value: [title],
  ...
  QueryBuilder<Post, Post, QAfterWhereClause> titleNotEqualTo(String? title) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Post, Post, QAfterWhereClause> titleGreaterThan(
    String? title, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Post, Post, QAfterWhereClause> titleLessThan(
    String? title, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Post, Post, QAfterWhereClause> titleBetween(
    String? lowerTitle,
    String? upperTitle, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Post, Post, QAfterWhereClause> titleStartsWith(
      String TitlePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'title',
  ...
  QueryBuilder<Post, Post, QAfterWhereClause> titleIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'title',
        value: [''],
  ...
  QueryBuilder<Post, Post, QAfterWhereClause> titleIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
